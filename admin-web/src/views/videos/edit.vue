...
const loadVideo = async () => {
  ...
  try {
    ...
    // 映射字段名：fileUrl -> videoUrl, thumbnailUrl -> coverUrl
    form.title = videoData.title;
    form.category = videoData.category;
    form.description = videoData.description || "";
    form.videoUrl = videoData.fileUrl || "";
    form.coverUrl = videoData.thumbnailUrl || "";
  } catch (error) {
  ...
  await formRef.value.validate(async (valid) => {
    if (valid) {
      ...
      try {
        ...
        await updateVideo(Number(id), videoData);
