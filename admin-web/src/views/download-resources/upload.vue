<template>
  <div class="download-resource-upload">
    <el-card>
      <template #header>
...
import { createDownloadResource } from "@/api/download-resources";
  ...
  await formRef.value.validate(async (valid) => {
    if (valid) {
      ...
      try {
        ...
        await createDownloadResource(resourceData);
